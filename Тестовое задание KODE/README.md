...
![](https://github.com/shatalina/data_science_YP/blob/main/%D0%A2%D0%B5%D1%81%D1%82%D0%BE%D0%B2%D0%BE%D0%B5%20%D0%B7%D0%B0%D0%B4%D0%B0%D0%BD%D0%B8%D0%B5%20KODE/taxi%20(1).jpg)
...
1. Алгоритм поиска машины по заказу должен подобрать свободного водителя со статусом "Свободен" в заданном радиусе и предложить ему выполнить текущий заказ.
Если водитель отказывается от заявки, то предложить следующему в списке водителю со статусом "Свободен" в заданном радиусе заказ. Делать это до тех пор пока список не окажется пуст.
2. Если водителя со статусом "Свободен" в данном радиусе нет или всеводители из этого списка отказались от заказа, то выбрать водителя, который в данном радиусе заканчивает заказ за заданное время, и предложить ему заказ. Если водитель отказывается от заявки, то предложить следующему в списке водителей заканчивающих заказ за заданное время в заданном радиусе, до тех пор пока список не окажется пуст.
3. Если водителей со статусом "Свободен" или "Заканчивает заказ" в заданном радиусе нет или все они отказались от заказа, то предложить клиенту повысить стоимость тарифа.
4. Если клиент согласился повысить тариф, то начать поиск водителя заново.
5. Если клиент отказался повысить тариф, то предложить ему подождать заданное время.
6. Если клиент согласился подождать заданное время, то подождать заданное время и начать поиск водителя заново.
7.  Если клиент отказался подождать заданное время, то отменить заказ.

![]([https://github.com/shatalina/data_science_YP/blob/main/%D0%A2%D0%B5%D1%81%D1%82%D0%BE%D0%B2%D0%BE%D0%B5%20%D0%B7%D0%B0%D0%B4%D0%B0%D0%BD%D0%B8%D0%B5%20KODE/taxi%20(1).jpg](https://github.com/shatalina/data_science_YP/blob/main/%D0%A2%D0%B5%D1%81%D1%82%D0%BE%D0%B2%D0%BE%D0%B5%20%D0%B7%D0%B0%D0%B4%D0%B0%D0%BD%D0%B8%D0%B5%20KODE/%D0%90%D0%BB%D0%B3%D0%BE%D1%80%D0%B8%D1%82%D0%BC%20%D0%BF%D0%BE%D0%B8%D1%81%D0%BA%D0%B0%20%D1%82%D0%B0%D0%BA%D1%81%D0%B8.jpg))
